 ...
 */
public class V1_2_2__change_privacy_policy_url extends BaseJavaMigration {
    private static final Logger LOG = LogFactory.getLogger(V1_2_2__change_privacy_policy_url.class);
    ...
    private boolean modifyConfig(Bundle bundle) throws Exception {
        ...
        config.put("privacyPolicyUrl", getUrls());
    ...
    public static JSONObject getUrls() throws JSONException {
