...
public class V1_1_2__add_hierarchical_layerlist_to_views implements JdbcMigration {
	
	private static final ViewService VIEW_SERVICE = new AppSetupServiceMybatisImpl();
	private static final  String HIERARCHICAL_LAYERLIST = "hierarchical-layerlist";
	...
	private void makeInsert(long viewId, Connection connection)
        ...
        statement.setString(2, HIERARCHICAL_LAYERLIST);
        statement.setLong(3, viewId);
        statement.setString(4, "{}");
        statement.setString(5, "{}");
        statement.setString(6, HIERARCHICAL_LAYERLIST);
        statement.setString(7, HIERARCHICAL_LAYERLIST);
