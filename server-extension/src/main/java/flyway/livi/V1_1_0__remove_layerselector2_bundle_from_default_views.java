...
public class V1_1_0__remove_layerselector2_bundle_from_default_views implements JdbcMigration {
    private static final Logger LOG = LogFactory.getLogger(V1_1_0__remove_layerselector2_bundle_from_default_views.class);

    private static final String BUNDLE_LAYERSELECTION2 = "layerselector2";
